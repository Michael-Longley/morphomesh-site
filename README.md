...
- **Credits page** (`credits/index.html`) — the project links (Astro Rocket Bank, Rocket Bank, Astronaut) and the video music attribution are left as bracketed placeholders; swap in the real URLs/credit text once available.
